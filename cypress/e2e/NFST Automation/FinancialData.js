export const financialDataYearOne = {
  ...
  export const financialDataYearTwo = generateFinancialData(financialDataYearOne, -10);
  export const financialDataYearThree = generateFinancialData(financialDataYearOne, +10);
