...
describe("Testing of the SPreading Tool", function () {
  it("Login url Verification", () => {
    ...
    cy.url().should("include", "xgencredit").and("contain", "qa");
  });
  ...
  it("Login", () => {
    ...
    cy.xpath(
      "/html/body/main/div/div[2]/div[2]/div/div/div[3]/div/button"
    ).click();
  });
  ...
  it("Add Financial", () => {
    ...
    cy.xpath(
      "/html/body/div[2]/div[3]/div/div[1]/div/div/div[2]/div[1]/div/div/input"
    ).type("30/09/2020");
    cy.get("#annualized_no").click;
    cy.xpath(
      "/html/body/div[2]/div[3]/div/div[1]/div/div/div[2]/div[1]/div/div/div/button"
    ).click();
    cy.xpath(
      "/html/body/div[2]/div[3]/div/div[1]/div/div/div[2]/div[1]/div/div/div/button"
    ).click();
...
.type("111");
    ...
    //Gross Profit
    cy.get('[id="2_otherOperatingExpenses"]').type(
      financialDataYearOne.otherOperatingExpenses
    );
    cy.get('[id="2_salariesAndWages"]').type(
      financialDataYearOne.salariesWages
    );
    ...
    cy.get('[id="2_floorplanInterest"]').type(
      financialDataYearOne.floorplanInterest
    );
    cy.get('[id="2_otherInterest"]').type(
      financialDataYearOne.leasingHPCharges
    );
    cy.get('[id="2_directorsRenumeration"]').type(
      financialDataYearOne.directorsRemuneration
    );
    ...
    cy.get('[id="2_accumilatedProfits"]').type(
      financialDataYearOne.accumulatedProfits
    );
    //Balance Sheet
    //Assets
    //Total Current Assets
    cy.get('[id="2_cashAndMarketable"]').type(
      financialDataYearOne.cashMarketableSec
    );
    ...
    cy.get('[id="2_vehiclesRecievables"]').type(
      financialDataYearOne.vehicleReceivables
    );
    ...
    cy.get('[id="2_inventPartsAndAccess"]').type(
      financialDataYearOne.inventPartsAccess
    );
    cy.get('[id="2_prepaidExpenses"]').type(
      financialDataYearOne.prepaidExpenses
    );
    cy.get('[id="2_tax"]').type(financialDataYearOne.taxGST);
    cy.get('[id="2_loansToRelatedParties"]').type(
      financialDataYearOne.loansRelatedParties
    );
    cy.get('[id="2_otherCurrentReceivables"]').type(
      financialDataYearOne.otherCurrentReceivables
    );
    //Total Fixed Assets
    ...
    cy.get('[id="2_accumulatedDepriciation"]').type(
      financialDataYearOne.accumulatedDepreciation
    );
    ...
    cy.get('[id="2_dueFromOfficers"]').type(
      financialDataYearOne.dueFromOfficers
    );
    cy.get('[id="2_otherIntengibles"]').type(
      financialDataYearOne.otherIntangibles
    );
    cy.get('[id="2_defferedTaxAsset"]').type(
      financialDataYearOne.deferredTaxAsset
    );
    //Total Assets
    //Liabilities and Networth
    //Total Current Liabilities
    cy.get('[id="2_staffAccruals"]').type(financialDataYearOne.staffAccruals);
    cy.get('[id="2_otherAccruals"]').type(
      financialDataYearOne.otherAccrualsProvision
    );
    cy.get('[id="2_accountsPaybleNew"]').type(
      financialDataYearOne.accountsPayable
    );
    cy.get('[id="2_notesPayble"]').type(
      financialDataYearOne.vehiclePayableNewDemo
    );
    cy.get('[id="2_accountsPaybleUsed"]').type(
      financialDataYearOne.vehiclePayableUsed
    );
    cy.get('[id="2_wholeSale"]').type(
      financialDataYearOne.wholesaleSoldNotPaid
    );
    cy.get('[id="2_shortTermDebt"]').type(financialDataYearOne.shortTermDebtHP);
    cy.get('[id="2_loansFromOfficersRelatedCompanies"]').type(
      financialDataYearOne.loansFromOfficers
    );
    ...
    cy.get('[id="2_otherCurrentLiabilities"]').type(
      financialDataYearOne.otherCurrentLiabilities
    );
    //Total Non-current Liabilities
    cy.get('[id="2_mortgageBankLoans"]').type(
      financialDataYearOne.mortgageBankLoans
    );
    cy.get('[id="2_loansFromOfficers"]').type(
      financialDataYearOne.loansFromOfficersOrRelatedCompanies
    );
    cy.get('[id="2_hirePurchase"]').type(financialDataYearOne.longTermDebtHP);
    cy.get('[id="2_subordinatedLoansFromOfficers"]').type(
      financialDataYearOne.subordinatedLoans
    );
    cy.get('[id="2_otherNonCurrentLiabilities"]').type(
      financialDataYearOne.otherNonCurrentLiabilities
    );
    cy.get('[id="2_paidUpCapital"]').type(financialDataYearOne.paidUpCapital);
    cy.get('[id="2_assetRevalAndReserve"]').type(
      financialDataYearOne.assetRevalReserve
    );
    ...
    cy.get('[id="2_devidendsOrWithdrawals"]').type(
      financialDataYearOne.dividendsWithdrawals
    );
    cy.get('[id="2_retainedEarnings"]').type(
      financialDataYearOne.retainedEarningsPreviousYear
    );
    cy.xpath(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[1]/table/thead/tr/th[2]"
    ).click();
    ...
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[5]/td[2]",
      financialKPIsYearOne.GrossProfit,
      "Gross Profit"
    );

    // Verification of Operating Expenses
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[6]/td[2]",
      financialKPIsYearOne.operatingExpenses,
      "Operating Expenses"
    );

    // Verification of Operating Profit Before Tax
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[15]/td[2]",
      financialKPIsYearOne.OperatingProfitBeforeTax,
      "Operating Profit Before Tax"
    );

    // Verification of Net Income (Profit)
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[17]/td[2]",
      financialKPIsYearOne.NetIncomeProfit,
      "Net Income (Profit)"
    );

    // Log Equation Values
    cy.log(
      `Equation Values ${financialKPIsYearOne.EBIT} = ${financialKPIsYearOne.NetIncomeProfit} ${financialDataYearOne.floorplanInterest} ${financialDataYearOne.leasingHPCharges}`
    );

    // Verification of EBIT
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[18]/td[2]",
      financialKPIsYearOne.EBIT,
      "EBIT"
    );

    // Verification of EBITDA
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[19]/td[2]",
      financialKPIsYearOne.EBITDA,
      "EBITDA"
    );

    // Verification of Net Profit After Tax
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[21]/td[2]",
      financialKPIsYearOne.NetProfitAfterTax,
      "Net Profit After Tax"
    );

    // Verification of Net Profit After Tax and Extraordinaries
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[23]/td[2]",
      financialKPIsYearOne.NetProfitAfterTaxAndExtraordinaries,
      "Net Profit After Tax and Extraordinaries"
    );

    // Verification of Retained Profits
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[26]/td[2]",
      financialKPIsYearOne.RetainedProfits,
      "Retained Profits"
    );

    // Verification of Total Current Assets
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[29]/td[2]",
      financialKPIsYearOne.totalCurrentAssets,
      "Total Current Assets"
    );

    // Verification of Total Fixed Assets
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[41]/td[2]",
      financialKPIsYearOne.totalFixedAssets,
      "Total Fixed Assets"
    );

    // Verification of Total Other Assets
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[47]/td[2]",
      financialKPIsYearOne.totalOtherAssets,
      "Total Other Assets"
    );

    // Log Total Assets
    cy.log(`Total Assets: ${financialKPIsYearOne.TotalAssets}`);

    // Verification of Total Assets
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[55]/td[2]",
      financialKPIsYearOne.TotalAssets,
      "Total Assets"
    );

    // Verification of Total Current Liabilities
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[57]/td[2]",
      financialKPIsYearOne.totalCurrentLiabilities,
      "Total Current Liabilities"
    );

    // Verification of Total Non-Current Liabilities
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[69]/td[2]",
      financialKPIsYearOne.totalNoncurrentLiabilities,
      "Total Non-Current Liabilities"
    );

    // Verification of Total Liabilities
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[75]/td[2]",
      financialKPIsYearOne.TotalLiabilities,
      "Total Liabilities"
    );

    // Verification of Total Net Worth
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[76]/td[2]",
      financialKPIsYearOne.TotalNetWorth,
      "Total Net Worth"
    );

    // Verification of Profit/(Loss) After Taxes
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[83]/td[2]/div",
      financialKPIsYearOne.NetProfitAfterTaxAndExtraordinaries,
    ...
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[84]/td[2]",
      financialKPIsYearOne.TotalLiabilitiesAndNetWorth,
      "Total Liabilities and Net Worth"
    );

    // Verification of BalanceChecker
    verifyFinancialValue(
      "/html/body/main/div/div/div/div[2]/div/div[1]/table[2]/table/tbody/tr[85]/td[2]",
      financialKPIsYearOne.BalanceChecker,
      "BalanceChecker"
    );
